...
import { EditarMotivoTroca } from "@/features/(cadastros)/motivos-trocas/components/editar-motivos-trocas-modal";
import { ExcluirMotivoTroca } from "@/features/(cadastros)/motivos-trocas/components/excluir-motivos-trocas-modal";

const codigoColumn = (): ColumnDef<IMotivoTroca, string> => {
  return {
    accessorKey: "codigo",
    id: "codigo",
    header: ({ column }) => (
...
const nomeColumn = (): ColumnDef<IMotivoTroca, string> => {
  return {
    accessorKey: "nome",
    id: "nome",
    header: ({ column }) => (
...
const createdAtColumn = (): ColumnDef<IMotivoTroca, string> => {
  return {
    accessorFn: (row) => {
...
const updatedAtColumn = (): ColumnDef<IMotivoTroca, string> => {
  return {
    accessorFn: (row) => {
...
const actionsColumn = (): ColumnDef<IMotivoTroca, any> => {
  return {
    accessorKey: "actions",
    id: "actions",
    header: ({ column }) => (
    ...
    cell: (info) => {
      ...
      return (
        <div className="flex items-center gap-1">
          <EditarMotivoTroca row={info.row} />
          <ExcluirMotivoTroca row={info.row} />
        </div>
      );
    },
  };
...
export const columns = (): ColumnDef<IMotivoTroca, any>[] => [
  codigoColumn(),
  nomeColumn(),
  createdAtColumn(),
  updatedAtColumn(),
