    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 bg-sidebar group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
...
const sidebarMenuButtonVariants = cva(
  "group/menu-button peer/menu-button flex items-center gap-2 data-open:hover:bg-sidebar-accent hover:bg-sidebar-accent/10 active:bg-sidebar-accent aria-disabled:opacity-50 disabled:opacity-50 p-2 group-data-[collapsible=icon]:p-2! group-has-data-[sidebar=menu-action]/menu-item:pr-8 rounded-md outline-hidden ring-sidebar-ring focus-visible:ring-2 w-full [&_svg]:size-4 group-data-[collapsible=icon]:size-8! overflow-hidden data-active:font-medium text-muted-foreground text-sm text-left [&>span:last-child]:truncate transition-[width,height,padding] data-active:bg-sidebar-accent-foreground/10 data-active:text-sidebar-accent-foreground data-open:hover:text-sidebar-accent-foreground hover:text-sidebar-accent-foreground active:text-sidebar-accent-foreground aria-disabled:pointer-events-none disabled:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        icon: "h-8 w-8 data-[state=collapsed]:mx-auto data-[state=collapsed]:p-1! group-data-[collapsible=icon]:size-10! group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
