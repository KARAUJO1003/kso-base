...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex flex-wrap items-center gap-1 bg-input/30 bg-clip-padding px-2.5 has-data-[slot=combobox-chip]:px-1 py-1 border border-input has-aria-invalid:border-destructive focus-within:border-ring dark:has-aria-invalid:border-destructive/50 rounded-lg has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20 focus-within:ring-3 focus-within:ring-ring/50 dark:has-aria-invalid:ring-destructive/40 min-h-8 text-sm transition-colors",
        className,
      )}
      {...props}
    />
